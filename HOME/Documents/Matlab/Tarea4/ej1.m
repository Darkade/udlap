...
% f(x)=x^3-3x +1
disp('1. Encuentre los máximos y minimos que tenga la función');
disp('      f(x)=x^3-3x+1')
disp('  usando fminbnd de MATLAB.')

ezplot('x^3-3*x+1');                 %Graficando la función
axis([-3 3 -4 4],'square');
grid;
...
disp(strcat('El máximo esta en:',num2str(min2),' con f(',num2str(min2),') = ',num2str(min2^3-3*min2+1)))
